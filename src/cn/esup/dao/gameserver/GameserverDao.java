...
package cn.esup.dao.gameserver;
 ...
 */
@Repository
public class GameserverDao extends HibernateDao<Gameserver, Long>{
	
	/** 通过父级对象主键查询下属对象列表 */
	@SuppressWarnings("unchecked")
	public List<Gameserver> queryGameserverTreeView(Long parentId) {
		Criteria criteria = getSession().createCriteria(Gameserver.class);
		if (parentId != null) {
	...
	/** 单个对象分页查询条件 */
	@SuppressWarnings("unchecked")
	public Page<Gameserver> queryGameserverGridView(String query, Page<Gameserver> page) {
	...
	@SuppressWarnings("unchecked")
	public Page<Gameserver> queryGameserverGridView(Long typeId, String query, Page<Gameserver> page) {
		List<PropertyFilter> filters = new LinkedList<PropertyFilter>();
		if (typeId != null) {
	...
	@SuppressWarnings("unchecked")
	public Page<Gameserver> queryGameserver(String query, Page<Gameserver> page){
		//	sql
		...
		List<Gameserver> list = session.createSQLQuery(sb.toString()).addEntity(Gameserver.class).list();
		page.setResult(list);
	...
	@SuppressWarnings("unchecked")
	public Page<Gameserver> queryNonPersistenceObject(String query, Page<Gameserver> page){
		//	sql
		...
		SQLQuery sqlQuery = (SQLQuery) session.createSQLQuery(sb.toString()).setResultTransformer(Transformers.aliasToBean(Gameserver.class));// 需要绑定的非hibernate持久化对象
