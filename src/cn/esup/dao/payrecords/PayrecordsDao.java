...
package cn.esup.dao.payrecords;
 ...
 */
@Repository
public class PayrecordsDao extends HibernateDao<Payrecords, Long>{
	
	/** 通过父级对象主键查询下属对象列表 */
	@SuppressWarnings("unchecked")
	public List<Payrecords> queryPayrecordsTreeView(Long parentId) {
		Criteria criteria = getSession().createCriteria(Payrecords.class);
		if (parentId != null) {
	...
	/** 单个对象分页查询条件 */
	@SuppressWarnings("unchecked")
	public Page<Payrecords> queryPayrecordsGridView(String query, Page<Payrecords> page) {
	...
	@SuppressWarnings("unchecked")
	public Page<Payrecords> queryPayrecordsGridView(Long typeId, String query, Page<Payrecords> page) {
		List<PropertyFilter> filters = new LinkedList<PropertyFilter>();
		if (typeId != null) {
	...
	@SuppressWarnings("unchecked")
	public Page<Payrecords> queryPayrecords(String query, Page<Payrecords> page){
		//	sql
		...
		List<Payrecords> list = session.createSQLQuery(sb.toString()).addEntity(Payrecords.class).list();
		page.setResult(list);
	...
	@SuppressWarnings("unchecked")
	public Page<Payrecords> queryNonPersistenceObject(String query, Page<Payrecords> page){
		//	sql
		...
		SQLQuery sqlQuery = (SQLQuery) session.createSQLQuery(sb.toString()).setResultTransformer(Transformers.aliasToBean(Payrecords.class));// 需要绑定的非hibernate持久化对象
