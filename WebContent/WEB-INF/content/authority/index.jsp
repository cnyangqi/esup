...
<html>
<head>
<title>Esup_角色权限</title>
<%@ include file="/common/meta.jsp"%>
<%@ include file="/common/header.jsp"%>
<script type="text/javascript" src="${ctx}/js/authority/authority.js"></script>
</head>
<body class="easyui-layout" style="height: 100%;width: 100%;overflow: hidden;border: none;visibility: hidden;">

	<%-- 界面布局 --%>
	<div region="west" iconCls="icon-key" title="角色管理" split="true" style="width:200px; padding:1px; overflow: auto;">
		<a href="javascript:add_win_ddt()" class="easyui-linkbutton" plain="true" iconCls="icon-key_add">新增</a>
		<a href="javascript:delete_ddt()" class="easyui-linkbutton" plain="true" iconCls="icon-key_delete">删除</a>
		<a href="javascript:edit_ddt()" class="easyui-linkbutton" plain="true" iconCls="icon-key_go">修改</a>
		<hr/>
		<!-- 数据字典类型树 -->
		<ul id="tree_ddt" class="easyui-tree" ></ul>
	</div>	
	
	<div region="center" iconCls="icon-key" title="权限管理" style="overflow: hidden;">
		<div class="easyui-layout" fit="true"> 
			<div class="easyui-panel" region="north" border="false" style="height: 40px; overflow: hidden;">
				<div style="clear: both;" class="SearchArea">
					...
					权限名称：<input id="auth_name" name="auth_name" type="text" size="10"/>
	...
	<%-- 角色窗口 --%>
	<div id="win_ddt" class="easyui-window" closed="true" modal="true" title="角色管理" style="width: 320px; height: 180px; padding: 5px; background: #fafafa;">
		<div class="easyui-layout" fit="true">
			<div region="center" style="padding: 10px; background: #fff; border: 1px solid #ccc;overflow: hidden;">
		...
		<div class="easyui-layout" fit="true">
			<div region="center" style="padding: 10px; background: #fff; border: 1px solid #ccc;overflow: hidden;">
				<form id="form_dd" action="" method="post">
					...
					<input type="hidden" name="id" /><!-- id -->
					<input type="hidden" name="roleId" /><!-- typeId -->
					
					<table align="center">
						<tr>
							<td align="right">所属角色：</td>
							<td>
							<input name="roleName" type="text" class="easyui-validatebox" required="true" readonly="readonly"/>
							<font color="red">*</font>
